import torch
from transformers import PreTrainedTokenizerFast, BartForConditionalGeneration, BertForSequenceClassification, BertTokenizer
import torch
...
print("긍정적인 감성의 확률:", sentiment_score)
